...
/*
Plugin Name: Contact Form 7 Range Slider Extender v2
Plugin URI:  https://github.com/CTAdevelopment/contactform7_range_extender_v2
Description: Extends usability of stock range slider available in Contact Form 7 plugin.
Version:     0.2
Author:      Daniel Drabik & Ko-Lin Chang
Author URI:  https://github.com/DanielDrabik - https://github.com/CTAdevelopment
License:     GPL3
...
function wpcf7_range_slider_extender_handler ( $tag ) {
	...
	$html = sprintf(
		'<span class="wpcf7-form-control-wrap %1$s"><input id="%5$s" oninput="output%5$s.value=%5$s.value" %2$s />%3$s</span><div id ="box_eromheen"><output class="contactform7-output" name="%1$s" id="output%5$s" for="%5$s">%4$s</output><p class="text_slider"> uur</p></div>',
